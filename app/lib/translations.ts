export const translations = {
  ...
  es: {
    ...
    whoIAmDesc: 'Soy un',
    whoIAmDesc2: 'apasionado con una sólida base en tecnologías web modernas. Me encanta convertir problemas complejos en soluciones simples, bonitas e intuitivas.',
    ...
    hours24: '24 horas',
    contactFormDesc: ' ¡Siéntete libre de comunicarte sobre oportunidades, colaboraciones, o solo para saludar!',
    contactFormDesc2: 'Ya sea que tengas un proyecto en mente, quieras discutir oportunidades, o quieras conectar, me encantaría saber de ti. ¡Creemos algo increíble juntos!',
    yourName: 'Tu nombre',
    nameLabel: 'Nombre',
