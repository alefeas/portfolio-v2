              ...
              <div className="p-8 space-y-8">
                ...
                <div className="flex gap-3">
                  ...
                  {selectedProject.isPrivate ? (
                    <div className="flex items-center gap-2 px-5 py-2.5 bg-slate-800/60 text-slate-300 rounded-lg border border-slate-700/40 justify-center text-sm font-medium cursor-not-allowed opacity-60" title="Código privado - Proyecto en desarrollo">
